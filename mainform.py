...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBoxDeleteVac.setGeometry(QtCore.QRect(30, 502, 251, 17))
        ...
        self.listView.setGeometry(QtCore.QRect(10, 30, 271, 171))
        self.listView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.listView.setObjectName("listView")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 13, 261, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.listViewRawData.setGeometry(QtCore.QRect(10, 227, 271, 271))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 210, 271, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(288, 30, 500, 541))
        self.plainTextEdit.setStyleSheet("color: rgb(0, 0, 0);")
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(298, 13, 481, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.checkBoxOpenExcel.setGeometry(QtCore.QRect(30, 520, 251, 17))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBoxDeleteVac.setText(_translate("MainWindow", "Вакансии из отчета необходимо удаить"))
        ...
        self.label_2.setText(_translate("MainWindow", "Данные для отчета:"))
