...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu.addAction(self.WaitFileAndCreateReport)
        self.menu.addSeparator()
        ...
        self.menu_3.addAction(self.EditReportForm)
        self.menu_3.addAction(self.EditRawFile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_3.setTitle(_translate("MainWindow", "Редакирование"))
        ...
        self.UCosts.setText(_translate("MainWindow", "Часовые ставки"))
        self.EMails.setText(_translate("MainWindow", "Адреса электронной почты пользователей"))
        ...
        self.ProjectsAddInfo.setText(_translate("MainWindow", "Дополнительная информация о контрактах"))
