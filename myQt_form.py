...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ReportMenu.addAction(self.OpenSavedReportsFolder)
        self.ReportMenu.addSeparator()
        self.ReportMenu.addAction(self.WaitFileAndCreateReport)
        self.ReportMenu.addSeparator()
        self.ReportMenu.addAction(self.Exit)
        self.DataMenu.addAction(self.OpenDownLoads)
        self.DataMenu.addAction(self.OpenUserFilesFolder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EditReportForm.setShortcut(_translate("MainWindow", "Ctrl+F2"))
        ...
        self.EditRawFile.setShortcut(_translate("MainWindow", "Alt+F2"))
        ...
        self.OpenDownLoads.setShortcut(_translate("MainWindow", "F5"))
        ...
        self.GetLastFileFromDownLoads.setShortcut(_translate("MainWindow", "Ctrl+Shift+F5"))
        ...
        self.MoveRawFile2Archive.setShortcut(_translate("MainWindow", "Ctrl+Shift+A"))
        ...
        self.FNSusbst.setText(_translate("MainWindow", "Подстановки названий функциональных направлений для отдельных проектов"))
        self.FNSusbst.setStatusTip(_translate("MainWindow", "Редактирование подстановок названий функциональных направлений для отдельных проектов"))
        ...
        self.WaitFileAndCreateReport.setText(_translate("MainWindow", "Дождаться новый файл в папке \'Загрузки\', обработать и сформировать отчёт"))
        self.WaitFileAndCreateReport.setStatusTip(_translate("MainWindow", "Дождаться новый файл в папке \'Загрузки\', обработать и сформировать отчёт"))
        self.WaitFileAndCreateReport.setShortcut(_translate("MainWindow", "Ctrl+Shift+F3"))
        ...
        self.OpenUserFilesFolder.setText(_translate("MainWindow", "Открыть папку с пользовательскими файлами"))
