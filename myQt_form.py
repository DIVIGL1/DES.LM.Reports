...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu.addAction(self.GetLastFileFromDownLoads)
        self.menu.addSeparator()
        self.menu.addAction(self.EditReportForm)
        self.menu.addAction(self.EditRawFile)
        self.menu.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CreateReport.setText(_translate("MainWindow", "Сформировать новый отчёт"))
        self.action_4.setText(_translate("MainWindow", "Открыть форму отчёта"))
        self.EditReportForm.setText(_translate("MainWindow", "Открыть выбранную форму отчёта"))
        self.EditRawFile.setText(_translate("MainWindow", "Открыть выбранный файл с данными"))
        ...
        self.OpenDownLoads.setText(_translate("MainWindow", "Открыть папку \'Загрузки\'"))
        self.action_5.setText(_translate("MainWindow", "Открыть форму отчёта"))
        self.GetLastFileFromDownLoads.setText(_translate("MainWindow", "Получить последний загруженный файл из папки \'Загрузки\'"))
