...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action2022 = QtWidgets.QAction(MainWindow)
        self.action2022.setObjectName("action2022")
        self.action2023 = QtWidgets.QAction(MainWindow)
        self.action2023.setObjectName("action2023")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Parameters4DESLM.setTitle(_translate("MainWindow", "Параметры запроса данных из DES.LM"))
        self.DESLM_Year.setTitle(_translate("MainWindow", "Выбран год:"))
        ...
        self.StopWaitingFile.setText(_translate("MainWindow", "Прекратить ожидание данных"))
        self.StopWaitingFile.setStatusTip(_translate("MainWindow", "Прекратить ожидание файла в папке \'Загрузки\' или из Интернет"))
        self.StopWaitingFile.setShortcut(_translate("MainWindow", "F7"))
        self.LoadDataFromDESLM.setText(_translate("MainWindow", "Загрузить данные из DES.LM в папку \'Загрузки\'"))
        self.LoadDataFromDESLM.setStatusTip(_translate("MainWindow", "Начать загрузку данных из DES.LM через Интернет и сохранить в папке \'Загрузки\'"))
        self.LoadDataFromDESLM.setShortcut(_translate("MainWindow", "Alt+F8"))
        self.action2022.setText(_translate("MainWindow", "2022"))
        self.action2023.setText(_translate("MainWindow", "2023"))
        self.LoadFromDELMAndCreateReport.setText(_translate("MainWindow", "Загрузить данные из DES.LM и сформировать отчёт"))
        self.LoadFromDELMAndCreateReport.setStatusTip(_translate("MainWindow", "Загрузить данные из DES.LM через Интернет и на основании них сформировать отчёт по выделенной форме"))
        self.LoadFromDELMAndCreateReport.setShortcut(_translate("MainWindow", "Ctrl+F8"))
        self.GetUserCode.setText(_translate("MainWindow", "Пользовательсткий код:"))
        self.GetUserCode.setStatusTip(_translate("MainWindow", "Скопировать пользовательский код в буфер обмена"))
        self.action1.setText(_translate("MainWindow", "1"))
        self.OpenRawDataFolder.setText(_translate("MainWindow", "\'Сырые\' данные из DES.LM"))
        self.OpenRawDataFolder.setStatusTip(_translate("MainWindow", "Открыть папку с \'cырыми\' данными из DES.LM"))
        self.OpenRawDataFolder.setShortcut(_translate("MainWindow", "Ctrl+4"))
