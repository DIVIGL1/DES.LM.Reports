...
" - сформировать из него отчёт")
        ...
        self.UpdateReportsFromInternet = QtWidgets.QAction(MainWindow)
        self.UpdateReportsFromInternet.setText("Загрузить обновление отчётов")
        self.UpdateReportsFromInternet.setIconText("Загрузить обновление отчётов")
        self.UpdateReportsFromInternet.setToolTip("Загрузить обновление отчётов")
        self.UpdateReportsFromInternet.setStatusTip("")
        self.UpdateReportsFromInternet.setWhatsThis("")
        self.UpdateReportsFromInternet.setShortcut("")
        self.UpdateReportsFromInternet.setObjectName("UpdateReportsFromInternet")
        self.CategoriesTypes = QtWidgets.QAction(MainWindow)
        self.CategoriesTypes.setText("Типы категорий")
        self.CategoriesTypes.setIconText("Типы категорий")
        self.CategoriesTypes.setToolTip("Типы категорий")
        self.CategoriesTypes.setStatusTip("")
        self.CategoriesTypes.setWhatsThis("")
        self.CategoriesTypes.setShortcut("")
        self.CategoriesTypes.setObjectName("CategoriesTypes")
        self.UCategories = QtWidgets.QAction(MainWindow)
        self.UCategories.setText("Категории специалистов")
        self.UCategories.setIconText("Категории специалистов")
        self.UCategories.setToolTip("Категории специалистов")
        self.UCategories.setStatusTip("")
        self.UCategories.setWhatsThis("")
        self.UCategories.setShortcut("")
        self.UCategories.setObjectName("UCategories")
        self.CCosts = QtWidgets.QAction(MainWindow)
        self.CCosts.setText("Ставки по категориям")
        self.CCosts.setIconText("Ставки по категориям")
        self.CCosts.setToolTip("Ставки по категориям")
        self.CCosts.setStatusTip("")
        self.CCosts.setWhatsThis("")
        self.CCosts.setShortcut("")
        self.CCosts.setObjectName("CCosts")
        ...
        self.DataMenu.addAction(self.UpdateReportsFromInternet)
        ...
        self.EditSettingsFiles.addSeparator()
        self.EditSettingsFiles.addAction(self.CategoriesTypes)
        self.EditSettingsFiles.addAction(self.UCategories)
        self.EditSettingsFiles.addAction(self.CCosts)
        self.EditSettingsFiles.addSeparator()
