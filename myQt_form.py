...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CreateReport.setToolTip("Сформировать новый отчёт на основе выделенного шаблона")
        ...
        self.EditReportForm.setIconText(" ")
        self.EditReportForm.setToolTip("Шаблон отчёта")
        ...
        self.EditRawFile.setIconText(" ")
        self.EditRawFile.setToolTip("Файл с данными")
        ...
        self.MoveRawFile2Archive.setToolTip("Переместить выделенный файл с данными в архив")
        ...
        self.Settings.setIconText(" ")
        self.Settings.setStatusTip("Файл с общими настройками программы")
        ...
        self.StopWaitingFile.setToolTip("Прекратить ожидание данных")
        ...
        self.LoadDataFromDESLM.setToolTip("Загрузить данные из DES.LM в папку \'Загрузки\'")
        ...
        self.LoadFromDELMAndCreateReport.setToolTip("Загрузить данные из DES.LM и сформировать отчёт")
        ...
        self.GetUserCode.setToolTip("Пользовательский код:")
